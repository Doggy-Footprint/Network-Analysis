...
구체적인 문제 해결 방식과 계약은 [저장소·Harness 병목 분석 접근 방식](7d605f56326ad0b3-analysis-approach.md)에서 관리한다. 공통 제약, 이전 기준선, 검토 후보와 부가 목표 전용 가정을 구분하며, 기존 상세 규칙은 이 문서에 중복하지 않는다.

| 관련 단계 | 상세 문서 |
|---|---|
| M1·M2: 그래프와 관측 기반 | [분석 모델](7d605f56326ad0b3-analysis-approach.md#분석-모델), [Snapshot과 읽기 표현](7d605f56326ad0b3-analysis-approach.md#snapshot과-읽기-표현) |
| M1·M3: 검색 장애 분석 | [검색 계약 상세](7d605f56326ad0b3-analysis-approach.md#검색-계약-상세) |
| M4·M6: 수정 위험·누락 | [Target-only 방법의 검토 후보](7d605f56326ad0b3-analysis-approach.md#target-only-방법의-검토-후보) |
| M3·M6: 후보와 결과 근거 | [병목 판정과 결과 추적성](7d605f56326ad0b3-analysis-approach.md#병목-판정과-결과-추적성) |
| M2·M5·M7: 실제 개선 검증 | [개선 효과 검증](7d605f56326ad0b3-analysis-approach.md#개선-효과-검증) |
