(function () {
  "use strict";
  const data = JSON.parse(document.getElementById("agent-view-data").textContent);
  ...
  [
    ...
    ["profile", summary.profile.id + " · v" + summary.profile.version],
    ["content hash", summary.profile.contentHash]
